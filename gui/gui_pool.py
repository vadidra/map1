...
#data1 = 2, None, None, None, None
data1 = 'ip', None, None, None
...
def process_msg(msg):
    ...
    for m1 in msg:
        ...
        for i, lri in enumerate(lr):
            str1 = str(lri[0]) + '     ' + str(lri[1]).rjust(2) + '     ' + str(lri[2]) + '     ' + "{:.2f}".format(lri[3]) + '     ' + str(lri[4]).rjust(2) + '     ' + str(lri[5])
